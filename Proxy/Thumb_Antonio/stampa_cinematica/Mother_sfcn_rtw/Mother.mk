...
MASTER_ANCHOR_DIR       = 
START_DIR               = /media/exo-hand/Data/Dropbox/Dropbox/RightHexoscheletonGit/Proxy/Thumb_Antonio/stampa_cinematica
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
SOLVER                  = 
NUMST                   = 1
...
COMPUTER                = GLNXA64
MEXEXT                  = mexa64
BUILDARGS               =  MODELLIB=Motherlib.a MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/Mother_sfcn_rtw \
	-I/media/exo-hand/Data/Dropbox/Dropbox/RightHexoscheletonGit/Proxy \
...
PROGRAM =  $(RELATIVE_PATH_TO_ANCHOR)/$(MODEL)_sf.$(MEXEXT)

#--------------------------------- Rules --------------------------------------

$(PROGRAM) : $(OBJS) $(LIBS)
	@echo "### Linking ..."
	$(CC) $(MEX_FLAGS) -MATLAB_ARCH=$(ARCH) -silent -outdir $(RELATIVE_PATH_TO_ANCHOR) $(LINK_OBJS) $(LIBS) $(LIBUT) $(LIBFIXPT)
