function [qo1, xJ, yJ] = calcolo_giunto_metacarpale(qB,lx, offx, offy, s)
...
% error = 0;
[qo1, xJ, yJ] = lenght_fun(qB, lx,param, offx, offy, s);

end

function [qo1, xJ, yJ]  = lenght_fun(qB, lx, measurements, offx, offy, s)
%#codegen
s_slitta = 13.5;
xL = offx; % FISSATO [mm]
yL = offy;
LIIp = abs(s) - s_slitta; % FISSATO [mm]
