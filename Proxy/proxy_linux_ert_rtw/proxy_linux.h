...
typedef struct {
  ...
  SL_Bus_proxy_linux_std_msgs_Float64MultiArray In1;/* '<S9>/In1' */
  SL_Bus_proxy_linux_std_msgs_Float64MultiArray b_varargout_2;
  real32_T ByteUnpack[17];             /* '<S4>/Byte Unpack' */
  ...
  real32_T xH_tmp_n;
  real32_T xH_tmp_p;
  real32_T xH_tmp_tmp_l;
  real32_T xH_tmp_j;
  real32_T xH_tmp_d;
  real32_T xH_tmp_gu;
  real32_T xH_tmp_tmp_ld;
  real32_T xH_tmp_dh;
  real32_T xH_tmp_tmp_tmp;
  real32_T xH_tmp_dy;
  real32_T xH_tmp_l;
  real32_T xH_tmp_o;
  real32_T xH_tmp_b;
  ...
  B_MATLABFunction_proxy_linux_T sf_MATLABFunction_d;/* '<S12>/MATLAB Function' */
  B_MATLABFunction_proxy_linux_T sf_MATLABFunction_o;/* '<S11>/MATLAB Function' */
} B_proxy_linux_T;
...
typedef struct {
  ...
  robotics_slros_internal_blo_k_T obj_k;/* '<S58>/SinkBlock' */
  robotics_slros_internal_blo_k_T obj_b;/* '<S57>/SinkBlock' */
  robotics_slros_internal_blo_k_T obj_a;/* '<S56>/SinkBlock' */
  robotics_slros_internal_blo_k_T obj_kr;/* '<S55>/SinkBlock' */
 ...
 *
 * '<Root>' : 'proxy_linux'
 * '<S1>'   : 'proxy_linux/Displays '
 * '<S2>'   : 'proxy_linux/From Ros'
 * '<S3>'   : 'proxy_linux/Generate SchunkCommands '
 * '<S4>'   : 'proxy_linux/Get Data From Hand'
 * '<S5>'   : 'proxy_linux/Send Data to Hand'
 * '<S6>'   : 'proxy_linux/To Verosim'
 * '<S7>'   : 'proxy_linux/ToRos'
 * '<S8>'   : 'proxy_linux/From Ros/Subscribe'
 * '<S9>'   : 'proxy_linux/From Ros/Subscribe/Enabled Subsystem'
 * '<S10>'  : 'proxy_linux/Generate SchunkCommands /Finger Spread'
 * '<S11>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger'
 * '<S12>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger'
 * '<S13>'  : 'proxy_linux/Generate SchunkCommands /Pinky'
 * '<S14>'  : 'proxy_linux/Generate SchunkCommands /Ring '
 * '<S15>'  : 'proxy_linux/Generate SchunkCommands /Thumb'
 * '<S16>'  : 'proxy_linux/Generate SchunkCommands /Finger Spread/MATLAB Function'
 * '<S17>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/MATLAB Function'
 * '<S18>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version'
 * '<S19>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version'
 * '<S20>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Condizionamento1'
 * '<S21>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Data Type Conversion Inherited'
 * '<S22>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Data Type Conversion Inherited1'
 * '<S23>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Finger Index 1'
 * '<S24>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Index New Pose Estimation '
 * '<S25>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Jacobian2'
 * '<S26>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Condizionamento1/Subsystem'
 * '<S27>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Condizionamento1/Subsystem/Radians to Degrees'
 * '<S28>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Condizionamento'
 * '<S29>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Finger Index '
 * '<S30>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/MATLAB Function'
 * '<S31>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Pose Generator'
 * '<S32>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Condizionamento/Subsystem'
 * '<S33>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Condizionamento/Subsystem/Radians to Degrees'
 * '<S34>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Pose Generator/Data Type Conversion Inherited'
 * '<S35>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Pose Generator/Data Type Conversion Inherited1'
 * '<S36>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Pose Generator/Jacobian2'
 * '<S37>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Pose Generator/Pose'
 * '<S38>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Data Type Conversion Inherited'
 * '<S39>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Data Type Conversion Inherited1'
 * '<S40>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Finger Index '
 * '<S41>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Jacobian2'
 * '<S42>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/MATLAB Function'
 * '<S43>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/MATLAB Function2'
 * '<S44>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/MATLAB Function3'
 * '<S45>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Subsystem'
 * '<S46>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Subsystem/Radians to Degrees'
 * '<S47>'  : 'proxy_linux/Generate SchunkCommands /Pinky/Pose Estimation'
 * '<S48>'  : 'proxy_linux/Generate SchunkCommands /Ring /Pose Estimation'
 * '<S49>'  : 'proxy_linux/Generate SchunkCommands /Thumb/MATLAB Function'
 * '<S50>'  : 'proxy_linux/Generate SchunkCommands /Thumb/MATLAB Function1'
 * '<S51>'  : 'proxy_linux/ToRos/Blank Message'
 * '<S52>'  : 'proxy_linux/ToRos/Blank Message1'
 * '<S53>'  : 'proxy_linux/ToRos/Blank Message2'
 * '<S54>'  : 'proxy_linux/ToRos/MATLAB Function - Assign'
 * '<S55>'  : 'proxy_linux/ToRos/Publish'
 * '<S56>'  : 'proxy_linux/ToRos/Publish1'
 * '<S57>'  : 'proxy_linux/ToRos/Publish12'
 * '<S58>'  : 'proxy_linux/ToRos/Publish2'
 */
