...
typedef struct {
  ...
  char_T cv3[20];
  char_T cv4[18];
  real_T Conversion_a[2];              /* '<S25>/Conversion' */
  ...
  real_T Gain2_b;                      /* '<S19>/Gain2' */
  SL_Bus_proxy_linux_std_msgs_Float64 b_varargout_2_m;
  real32_T DataTypeConversion_c[2];    /* '<S14>/Data Type Conversion' */
  real32_T Sum_k;                      /* '<S23>/Sum' */
  real32_T Sum2;                       /* '<S31>/Sum2' */
  real32_T Sum_l;                      /* '<S52>/Sum' */
  real32_T Sum2_j;                     /* '<S60>/Sum2' */
  real32_T Sum2_f;                     /* '<S17>/Sum2' */
  real32_T Sum2_h;                     /* '<S67>/Sum2' */
  real32_T Sum2_i;                     /* '<S71>/Sum2' */
  real32_T TmpSignalConversionAtBytePackIn[12];
  real32_T TmpSignalConversionAtBytePack_b[11];
  real32_T DataTypeConversion;         /* '<S76>/Data Type Conversion' */
  real32_T Memory;                     /* '<S22>/Memory' */
  ...
  SL_Bus_proxy_linux_std_msgs_Bool b_varargout_2_b;
  SL_Bus_proxy_linux_std_msgs_Bool BusAssignment2;/* '<S7>/Bus Assignment2' */
  B_EnabledSubsystem_proxy_linu_T EnabledSubsystem_f;/* '<S86>/Enabled Subsystem' */
  B_Subsystem_proxy_linux_T Subsystem_p;/* '<S71>/Subsystem' */
  B_Subsystem_proxy_linux_T Subsystem_cc;/* '<S67>/Subsystem' */
  B_Subsystem_proxy_linux_T Subsystem_f;/* '<S17>/Subsystem' */
  B_Subsystem_proxy_linux_T Subsystem_c;/* '<S60>/Subsystem' */
  ...
  B_Subsystem_proxy_linux_T Subsystem_a;/* '<S52>/Subsystem' */
  B_Subsystem_proxy_linux_T Subsystem_l;/* '<S31>/Subsystem' */
  ...
  B_Subsystem_proxy_linux_T Subsystem; /* '<S23>/Subsystem' */
...
typedef struct {
  ...
  real32_T Memory_PreviousInput;       /* '<S22>/Memory' */
  robotics_slros_internal_block_T obj; /* '<S86>/SourceBlock' */
  robotics_slros_internal_block_T obj_e;/* '<S75>/SourceBlock' */
  robotics_slros_internal_block_T obj_c;/* '<S11>/SourceBlock' */
  robotics_slros_internal_block_T obj_i;/* '<S9>/SourceBlock' */
  robotics_slros_internal_blo_k_T obj_k;/* '<S85>/SinkBlock' */
  robotics_slros_internal_blo_k_T obj_b;/* '<S84>/SinkBlock' */
  robotics_slros_internal_blo_k_T obj_a;/* '<S83>/SinkBlock' */
  robotics_slros_internal_blo_k_T obj_kr;/* '<S82>/SinkBlock' */
  boolean_T objisempty;                /* '<S86>/SourceBlock' */
  boolean_T objisempty_h;              /* '<S85>/SinkBlock' */
  boolean_T objisempty_k;              /* '<S84>/SinkBlock' */
  boolean_T objisempty_l;              /* '<S83>/SinkBlock' */
  boolean_T objisempty_c;              /* '<S82>/SinkBlock' */
  boolean_T objisempty_f;              /* '<S75>/SourceBlock' */
  boolean_T objisempty_f4;             /* '<S11>/SourceBlock' */
  boolean_T objisempty_cw;             /* '<S9>/SourceBlock' */
  DW_Subsystem_proxy_linux_T Subsystem_p;/* '<S71>/Subsystem' */
  DW_Subsystem_proxy_linux_T Subsystem_cc;/* '<S67>/Subsystem' */
  DW_Subsystem_proxy_linux_T Subsystem_f;/* '<S17>/Subsystem' */
  DW_Subsystem_proxy_linux_T Subsystem_c;/* '<S60>/Subsystem' */
  DW_Subsystem_proxy_linux_T Subsystem_a;/* '<S52>/Subsystem' */
  DW_Subsystem_proxy_linux_T Subsystem_l;/* '<S31>/Subsystem' */
  DW_Subsystem_proxy_linux_T Subsystem;/* '<S23>/Subsystem' */
} DW_proxy_linux_T;
...
struct P_proxy_linux_T_ {
  ...
  SL_Bus_proxy_linux_std_msgs_Bool Constant_Value_n;/* Computed Parameter: Constant_Value_n
                                                     ...
                                                     */
  SL_Bus_proxy_linux_std_msgs_Float64 Out1_Y0_o;/* Computed Parameter: Out1_Y0_o
                                                 * Referenced by: '<S77>/Out1'
                                                 */
  SL_Bus_proxy_linux_std_msgs_Float64 Constant_Value_bz;/* Computed Parameter: Constant_Value_bz
  ...
  real32_T Constant_Value_gc;          /* Computed Parameter: Constant_Value_gc
                                        ...
                                        */
  real32_T Out1_Y0_m;                  /* Computed Parameter: Out1_Y0_m
  ...
  boolean_T Constant_Value_ok;         /* Computed Parameter: Constant_Value_ok
                                        ...
                                        */
  P_EnabledSubsystem_proxy_linu_T EnabledSubsystem_f;/* '<S86>/Enabled Subsystem' */
  P_Subsystem_proxy_linux_T Subsystem_p;/* '<S71>/Subsystem' */
  P_Subsystem_proxy_linux_T Subsystem_cc;/* '<S67>/Subsystem' */
  P_Subsystem_proxy_linux_T Subsystem_f;/* '<S17>/Subsystem' */
  P_Subsystem_proxy_linux_T Subsystem_c;/* '<S60>/Subsystem' */
  P_Subsystem_proxy_linux_T Subsystem_a;/* '<S52>/Subsystem' */
  P_Subsystem_proxy_linux_T Subsystem_l;/* '<S31>/Subsystem' */
  P_Subsystem_proxy_linux_T Subsystem; /* '<S23>/Subsystem' */
 ...
 * Block '<S67>/Display4' : Unused code path elimination
 ...
 * '<S21>'  : 'proxy_linux/Generate SchunkCommands /Finger Spread/calibration1'
 * '<S22>'  : 'proxy_linux/Generate SchunkCommands /Finger Spread/calibration1/Subsystem1'
 * '<S23>'  : 'proxy_linux/Generate SchunkCommands /Index/Calibration'
 * '<S24>'  : 'proxy_linux/Generate SchunkCommands /Index/Data Type Conversion Inherited'
 * '<S25>'  : 'proxy_linux/Generate SchunkCommands /Index/Data Type Conversion Inherited1'
 * '<S26>'  : 'proxy_linux/Generate SchunkCommands /Index/Finger Index '
 * '<S27>'  : 'proxy_linux/Generate SchunkCommands /Index/Jacobian2'
 * '<S28>'  : 'proxy_linux/Generate SchunkCommands /Index/MATLAB Function'
 * '<S29>'  : 'proxy_linux/Generate SchunkCommands /Index/MATLAB Function2'
 * '<S30>'  : 'proxy_linux/Generate SchunkCommands /Index/MATLAB Function3'
 * '<S31>'  : 'proxy_linux/Generate SchunkCommands /Index/Subsystem'
 * '<S32>'  : 'proxy_linux/Generate SchunkCommands /Index/Calibration/Subsystem'
 * '<S33>'  : 'proxy_linux/Generate SchunkCommands /Index/Subsystem/Radians to Degrees'
 * '<S34>'  : 'proxy_linux/Generate SchunkCommands /Index/Subsystem/Subsystem'
 * '<S35>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/MATLAB Function'
 * '<S36>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version'
 * '<S37>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version'
 * '<S38>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Condizionamento1'
 * '<S39>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Data Type Conversion Inherited'
 * '<S40>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Data Type Conversion Inherited1'
 * '<S41>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Finger Index 1'
 * '<S42>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Index New Pose Estimation '
 * '<S43>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Jacobian2'
 * '<S44>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/New Version/Condizionamento1/Subsystem'
 * '<S45>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Condizionamento'
 * '<S46>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Finger Index '
 * '<S47>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/MATLAB Function'
 * '<S48>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Pose Generator'
 * '<S49>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Condizionamento/Subsystem'
 * '<S50>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Pose Generator/Jacobian2'
 * '<S51>'  : 'proxy_linux/Generate SchunkCommands /Index  Finger/Old Version/Pose Generator/Pose'
 * '<S52>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Calibration'
 * '<S53>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Data Type Conversion Inherited'
 * '<S54>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Data Type Conversion Inherited1'
 * '<S55>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Finger Index '
 * '<S56>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Jacobian2'
 * '<S57>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/MATLAB Function'
 * '<S58>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/MATLAB Function2'
 * '<S59>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/MATLAB Function3'
 * '<S60>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Subsystem'
 * '<S61>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Calibration/Subsystem'
 * '<S62>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Subsystem/Radians to Degrees'
 * '<S63>'  : 'proxy_linux/Generate SchunkCommands /Middle Finger/Subsystem/Subsystem'
 * '<S64>'  : 'proxy_linux/Generate SchunkCommands /Pinky/Pose Estimation'
 * '<S65>'  : 'proxy_linux/Generate SchunkCommands /Pinky/Subsystem'
 * '<S66>'  : 'proxy_linux/Generate SchunkCommands /Ring /Pose Estimation'
 * '<S67>'  : 'proxy_linux/Generate SchunkCommands /Ring /calibration'
 * '<S68>'  : 'proxy_linux/Generate SchunkCommands /Ring /calibration/Subsystem'
 * '<S69>'  : 'proxy_linux/Generate SchunkCommands /Thumb/MATLAB Function'
 * '<S70>'  : 'proxy_linux/Generate SchunkCommands /Thumb/MATLAB Function1'
 * '<S71>'  : 'proxy_linux/Generate SchunkCommands /Thumb/calibration'
 * '<S72>'  : 'proxy_linux/Generate SchunkCommands /Thumb/calibration1'
 * '<S73>'  : 'proxy_linux/Generate SchunkCommands /Thumb/calibration/Subsystem'
 * '<S74>'  : 'proxy_linux/Generate SchunkCommands /Thumb/calibration1/Subsystem1'
 * '<S75>'  : 'proxy_linux/Send Data to Hand/Subscribe'
 * '<S76>'  : 'proxy_linux/Send Data to Hand/Subsystem'
 * '<S77>'  : 'proxy_linux/Send Data to Hand/Subscribe/Enabled Subsystem'
 * '<S78>'  : 'proxy_linux/ToRos/Blank Message'
 * '<S79>'  : 'proxy_linux/ToRos/Blank Message1'
 * '<S80>'  : 'proxy_linux/ToRos/Blank Message2'
 * '<S81>'  : 'proxy_linux/ToRos/MATLAB Function - Assign'
 * '<S82>'  : 'proxy_linux/ToRos/Publish'
 * '<S83>'  : 'proxy_linux/ToRos/Publish1'
 * '<S84>'  : 'proxy_linux/ToRos/Publish12'
 * '<S85>'  : 'proxy_linux/ToRos/Publish2'
 * '<S86>'  : 'proxy_linux/ToRos/Subscribe'
 * '<S87>'  : 'proxy_linux/ToRos/Subsystem'
 * '<S88>'  : 'proxy_linux/ToRos/Subsystem1'
 * '<S89>'  : 'proxy_linux/ToRos/Subsystem2'
 * '<S90>'  : 'proxy_linux/ToRos/Subsystem3'
 * '<S91>'  : 'proxy_linux/ToRos/To Verosim'
 * '<S92>'  : 'proxy_linux/ToRos/Subscribe/Enabled Subsystem'
 */
