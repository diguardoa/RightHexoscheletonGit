###########################################################################
## Makefile generated for Simulink model 'proxy_linux'. 
## 
## Makefile     : proxy_linux.mk
## Generated on : Tue Oct 31 13:03:33 2017
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/proxy_linux.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/antonio/Documenti/RightHexoscheletonGit/Proxy
ARCH                      = glnxa64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = proxy_linux_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/proxy_linux.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/include -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/proxy_linux_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/robotics/robotsimulink/@slCustomizer/../robotslros/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=proxy_linux -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DTID01EQ=0 -DROS_PROJECT -DMW_SCHED_OTHER -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT=RT -D_USE_TARGET_UDP_
...
DEFINES_STANDARD = -DMODEL=proxy_linux -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/src/DAHostLib_Network.c $(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/src/DAHostLib_rtw.c $(START_DIR)/proxy_linux_ert_rtw/proxy_linux.cpp $(START_DIR)/proxy_linux_ert_rtw/proxy_linux_data.cpp $(START_DIR)/proxy_linux_ert_rtw/rtGetInf.cpp $(START_DIR)/proxy_linux_ert_rtw/rtGetNaN.cpp $(START_DIR)/proxy_linux_ert_rtw/rt_nonfinite.cpp $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.cpp $(START_DIR)/proxy_linux_ert_rtw/slros_busmsg_conversion.cpp $(START_DIR)/proxy_linux_ert_rtw/slros_initialize.cpp /home/antonio/MATLAB/toolbox/robotics/robotsimulink/robotslros/src/slros_generic_param.cpp $(MATLAB_ROOT)/toolbox/robotics/robotsimulink/robotslros/src/linuxUDP.c

MAIN_SRC = $(START_DIR)/proxy_linux_ert_rtw/ert_main.cpp
...
OBJS = DAHostLib_Network.c.o DAHostLib_rtw.c.o proxy_linux.cpp.o proxy_linux_data.cpp.o rtGetInf.cpp.o rtGetNaN.cpp.o rt_nonfinite.cpp.o linuxinitialize.cpp.o slros_busmsg_conversion.cpp.o slros_initialize.cpp.o /home/antonio/MATLAB/toolbox/robotics/robotsimulink/robotslros/src/slros_generic_param.cpp.o linuxUDP.c.o
...
%.c.o : $(START_DIR)/proxy_linux_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/proxy_linux_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/proxy_linux_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
