...
%%
fattore_moltiplicativo = 1.35880;
y_pre = abs((y_temp(1)-angle_to_reach)^2 + (y_temp(2)-fattore_moltiplicativo*angle_to_reach )^2 + (fattore_moltiplicativo*y_temp(1) - y_temp(2))^2);
