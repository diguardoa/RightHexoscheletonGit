function plotFingerKinematic(measurements,parameters,u)
...
p_K_0 = [0,0,0,1]';
p_A_0 = T_N_0*DH(-(qN-qKN),LAN)*[0,0,0,1]';
p_B_0 = DH(pi-qK, LKB)*[0,0,0,1]'; 
p_A_0_loop = DH((pi-qK), LKB)*DH((qB-pi), LAB)*[0,0,0,1]';
...
loop1 = [p_K_0,p_B_0, p_A_0, p_A_0_loop, p_N_0]; % p_A_0, p_A_0_loop devono essere uguali, se no errore
